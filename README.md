...
Current Editor 采用语义化版本号命名，格式为 `v<主版本号>.<次版本号>.<修订版本号>`。

- **主版本号**：当引入不兼容的 API 修改时，主版本号会增加。
- **次版本号**：当添加功能在向后兼容的前提下，次版本号会增加。
- **修订版本号**：当修复向后兼容的问题时，修订版本号会增加。

例如，`v0.1.0` 表示初始版本，`v0.2.0` 表示添加了新功能，`v0.2.1` 表示修复了一个问题。

**对于 0.x 版本**

- 这些版本主要用于测试和功能完善，不建议在生产环境中使用。
- 每个版本的发布都可能包含新功能、改进和修复，比如 v0.1.1 引进了很多新特性
- 这里的 _修订版本号_ 主要看用户界面的功能引入，重构、优化等并不会增加次版本号
